...
def handle_run(
    ...
    **kwargs,
    ...
    try:
        ...
        # Always use environment-aware reduction for full dynamic compilation support
        ...
        if execute:
            ...
            try:
                # Always use environment-aware execution for full dynamic compilation support
