...
_PRIMITIVES: dict[str, tuple[Callable[..., Any], AritySpec, str]] = {
    ...
    "not_compat": (kernels.not_compat, AritySpec.fixed(1), "Compatibility plain not for scalars and images"),
    "num_eq": (kernels.num_eq, AritySpec.fixed(2), "Scalar floating-point equality"),
    "num_neq": (kernels.num_neq, AritySpec.fixed(2), "Scalar floating-point inequality"),
    ...
    "==": (kernels.equal, AritySpec.fixed(2), "Scalar or voxel-wise equality"),
    "!=": (kernels.not_equal, AritySpec.fixed(2), "Scalar or voxel-wise inequality"),
    "<": (kernels.less, AritySpec.fixed(2), "Scalar or voxel-wise less-than"),
    "<=": (kernels.less_equal, AritySpec.fixed(2), "Scalar or voxel-wise less-or-equal"),
    ">": (kernels.greater, AritySpec.fixed(2), "Scalar or voxel-wise greater-than"),
    ">=": (kernels.greater_equal, AritySpec.fixed(2), "Scalar or voxel-wise greater-or-equal"),
    ...
    "gradient": (kernels.gradient, AritySpec.fixed(1), "Gradient magnitude of an image"),
    ...
    "avg0": (kernels.avg0, AritySpec.fixed(2), "Average value in a boolean mask, 0 if empty"),
